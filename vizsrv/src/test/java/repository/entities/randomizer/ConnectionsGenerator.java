package repository.entities.randomizer;
...
public class ConnectionsGenerator {
    private static final int CONNECTIONS_NUMBER = 100;
    private static final int HOSTS_NUMBER = 30;
    private static final int MAX_OCCURRENCES_NUMBER = 100;
